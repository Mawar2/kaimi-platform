  ...
  <div class="review">
    ...
    <div class="r-body">
      ...
      <div class="art-row">
        ...
        <a class="artifact2" href="/workspace/{{.Opp.ID}}/compliance.csv" download>` + iconDoc + `Compliance matrix (CSV)<span style="color:var(--ink-4);font-size:11px">requirements → coverage</span></a>
