...
// privacyPage is privacyHTML with the shared brand favicon + the Kai wave logo (the same mark
// the dashboard uses) injected once at init, so the public pages match the app's branding.
var privacyPage = strings.NewReplacer(
...
<body><div class="wrap">
  <div class="brand"><span class="mk"><!--MARK--></span><div><h1>Kaimi</h1><div class="tag">Privacy Policy</div></div></div>
