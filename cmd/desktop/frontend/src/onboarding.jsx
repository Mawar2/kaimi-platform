...
import { I, Btn, Avatar } from './shared.jsx';
import { KAIMI_AGENTS } from './data.js';
/* ============================================================
          ...
          {step===4 && (
            <React.Fragment>
              ...
              <div className="ob-body">
                <div className="team">
                  <div className="tcard">
                    <Avatar agent={KAIMI_AGENTS.outline} size="lg" />
                  ...
                  <div className="tcard">
                    <Avatar agent={KAIMI_AGENTS.writer} size="lg" />
                  ...
                  <div className="tcard">
                    <Avatar agent={KAIMI_AGENTS.review} size="lg" />
